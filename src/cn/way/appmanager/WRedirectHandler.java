 ...
 */
public class WRedirectHandler extends DefaultRedirectHandler {

    private static final String REDIRECT_LOCATIONS = "http.protocol.redirect-locations";
    private final boolean enableRedirects;

    public WRedirectHandler(final boolean allowRedirects) {
        super();
    ...
    public boolean isRedirectRequested(
    	...
    	WLog.d("#####isRedirectRequested : "+enableRedirects);
        if (!enableRedirects) {
            return false;
        }
        if (response == null) {
        ...
        WLog.d("#####isRedirectRequested : "+statusCode);
        switch (statusCode) {
    ...
    public URI getLocationURI(
        ...
        for (Header h : response.getAllHeaders()) {
        	WLog.d("#####getLocationURI : "+h.toString());
		}
        ...
        String location = locationHeader.getValue()
        		...
        		.replace("\n", "")
        		.replace("\r\n", "");
        WLog.d("#####getLocationURI : "+location);
        URI uri;
        try {
